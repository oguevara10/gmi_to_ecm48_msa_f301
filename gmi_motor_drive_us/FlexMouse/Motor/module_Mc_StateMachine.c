                                   ...
                                   uint8_t irq_id_u8) 
{
  ...
  if( (next_State_u8 != INIT_MODULE)&& (MC_GetSTMStateMotor1() == FAULT_NOW) ) { // SPA On power up motor state is FAULT_NOW causing motor not to spin due to skipping Init state
